---
{"dg-publish":true,"permalink":"/article-full/useful-patterns-for-building-html-tools/","title":"Useful patterns for building HTML tools","tags":["article","full"]}
---

# Useful patterns for building HTML tools  

Source: [simonwillison.net](https://simonwillison.net/2025/Dec/10/html-tools/)  

#HTMLTools #LLM #WebDev #JavaScript  
...
1. [Getting DeepSeek-OCR working on an NVIDIA Spark via brute force using Claude Code](https://simonwillison.net/2025/Oct/20/deepseek-ocr-claude-code/) - Oct. 20, 2025, 5:21 p.m.
2. [Video: Building a tool to copy-paste share terminal sessions using Claude Code for web](https://simonwillison.net/2025/Oct/23/claude-code-for-web-video/) - Oct. 23, 2025, 4:14 a.m.
3. [Video + notes on upgrading a Datasette plugin for the latest 1.0 alpha, with help from uv and OpenAI Codex CLI](https://simonwillison.net/2025/Nov/6/upgrading-datasette-plugins/) - Nov. 6, 2025, 6:26 p.m.
4. **Useful patterns for building HTML tools** - Dec. 10, 2025, 9 p.m.
5. [I ported JustHTML from Python to JavaScript with Codex CLI and GPT-5.2 in 4.5 hours](https://simonwillison.net/2025/Dec/15/porting-justhtml/) - Dec. 15, 2025, 11:58 p.m.
6. [Cooking with Claude](https://simonwillison.net/2025/Dec/23/cooking-with-claude/) - Dec. 23, 2025, 5:01 a.m.

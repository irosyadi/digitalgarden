---
{"dg-publish":true,"permalink":"/article-full/andrej-s-advice-for-success/","title":"Andrej's advice for success","tags":["article","full"]}
---

# Andrej's advice for success  

Source: [stanford.edu](https://cs.stanford.edu/people/karpathy/advice.html)  

#StudyTips #AcademicSuccess #TestPreparation #Productivity  
...
## Additional Discussion on HN

Absolutely—here’s a curated set of **additional insights** from the Hacker News discussion that expand and sometimes challenge Andrej Karpathy’s original guide. These reflect lived experience, pedagogical nuance, and a healthy dose of skepticism:

---

## 🧩 Lecture Engagement & Learning Styles

- **Predictive Listening**: Try to anticipate what the lecturer will say next. It keeps you mentally active and builds intuition.
- **Lecture ≠ Learning**: Many found lectures inefficient—like watching a Let’s Play of math. Real learning happens during problem-solving at home.
- **Note-Taking Tradeoffs**: Writing notes can help engagement, but some prefer no notes to stay mentally ahead. Others rewrite notes post-class to reinforce memory.
- **Lecture Format Matters**: PowerPoint-heavy lectures often fail to convey logic. Chalk-and-talk or interactive formats are more effective.

---

## 🧠 Cognitive Strategies

- **Sleep as Solver**: Attempt a problem, then sleep on it. Your brain may resolve it overnight.
- **Short-Term Memory Boost**: Studying intensely right before a test can help with recall—but only if you’ve already done deep prep.
- **Active Recall > Passive Reading**: Re-derive proofs, explain concepts aloud, or teach others to solidify understanding.

---

## 🧑‍🤝‍🧑 Social & Emotional Dimensions

- **Study Groups as Multipliers**: Teaching peers—especially weaker ones—deepens your own understanding.
- **Office Hours Ethics**: Visiting profs for hints may feel manipulative. Some argue it’s strategic; others see it as gaming the system.
- **Camaraderie Counts**: Shared struggle builds friendships and networks. All-nighters, while academically suboptimal, can forge lasting bonds.

---

## 🧭 Meta-Learning & Mindset

- **Learning to Learn**: Regularity and self-awareness trump raw intelligence. Pomodoro timers and daily effort beat sporadic genius.
- **Curves & Grading Cynicism**: Grading systems often distort effort and ability. Focus on mastery, not metrics.
- **Tunnel Vision Trap**: Don’t over-invest in GPA. Projects, blogs, and open-source work build real-world credibility.
- **Beware Bad Advice**: Online cynicism can derail motivation. Cultivate discernment and personal responsibility.

---

## 🧘 Environment & Personalization

- **Quiet ≠ Focus for All**: Some thrive in silent libraries; others need ambient noise and music. Know your optimal zone.
- **Discipline > Hacks**: Time management and consistent effort remain the bedrock of success—no shortcut replaces real work.

---

This discussion adds texture to Karpathy’s original advice: it’s not just about tactics, but also about mindset, ethics, and adaptability. Want to turn this into a comparative slide deck or a visual decision tree for learners?